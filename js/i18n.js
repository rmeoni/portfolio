(function () {
  ...
  var BASE_PATH = CURRENT_SCRIPT ? CURRENT_SCRIPT.src.replace(/js\/i18n\.js(?:\?.*)?$/, '') : '';
  var LANG_ICON_LIGHT = BASE_PATH + 'images/language.svg';
  var LANG_ICON_DARK  = BASE_PATH + 'images/language-dark.svg';
  ...
  var translations = {
    en: {
      ...
      /* ── IxDF Meet #4 ── */
      'ixdf-meet4-page-title': 'Interaction Design Foundation (IxDF) Guatemala City Meet #4: The Accessibility Challenge in Guatemala',
      'ixdf-meet4-title':      'IxDF Guatemala City Meet #4: Accessibility in Guatemala',
      'ixdf-meet4-host':       'Rodrigo Meoño<br><span class="text-grey">Senior UX Developer</span><br><span class="text-grey">Country Manager @ IxDF Guatemala</span>',
      'ixdf-meet4-intro':      'Designing for more than 25 cultures: that\'s the accessibility challenge in Guatemala. In this Interaction Design Foundation (IxDF) Guatemala City Meet #4 session, I walked the local UX community through why accessibility deserves more attention in Guatemala than in almost any other market. Starting from the classic UX honeycomb — useful, usable, findable, credible, desirable, accessible, and valuable — I explained that accessibility means any person, regardless of ability, should be able to use what we design, and that equity means adjusting our tools so everyone, not just the majority, can actually reach the same outcome. From there we dug into Google\'s "Next Billion Users" framework and a set of socioeconomic statistics that make Guatemala\'s design landscape uniquely challenging, before opening the floor to an interactive discussion and a collaborative Jamboard exercise on how local products could become more accessible.',
      'ixdf-meet4-about-h2':   'About the Session',
      'ixdf-meet4-about-p':    'The goal of the talk was to show that accessibility isn\'t a checkbox — it\'s a direct response to who our users actually are. I shared the quantitative research process I use with every client, in Guatemala or abroad, before designing a single screen: gathering hard demographic data on literacy, language, income, banking access, and disability rates before making assumptions about how someone will use a product. We then opened the floor to the group — UX designers, developers, and team leads from across Guatemala — to share real examples of apps and everyday technology that got accessibility right, and ones that clearly didn\'t.',
      'ixdf-meet4-stats-h2':   'Guatemala by the Numbers',
      'ixdf-meet4-stats-p':    'These are some of the statistics I shared to ground the conversation in data rather than assumptions:',
      'ixdf-meet4-stats-ul':   '<li><strong>Population &amp; language:</strong> 18 million people, roughly 70% of whom speak Spanish. The country officially recognizes 25 languages — Spanish, 22 Mayan languages, Xinca, and Garífuna — spoken by about 6 million people who don\'t primarily communicate in Spanish.</li><li><strong>Literacy:</strong> An estimated 83% adult literacy rate, meaning roughly 1 in 5 adults — around 3 million people — still can\'t read or write.</li><li><strong>Education:</strong> Only 54.6% of adults over 25 completed primary school, 33.9% completed lower secondary, and just 5.1% hold a university degree.</li><li><strong>Connectivity:</strong> About 20.4 million mobile connections for the population, but only around 56–60% internet penetration and roughly 10.4 million active social media accounts.</li><li><strong>Economy &amp; banking:</strong> 56% of the population lives in poverty (16.2% in extreme poverty), and only 65% of adults have a bank account.</li><li><strong>Disability:</strong> 22.4% of adults 15 and older report some functional difficulty — vision, mobility, self-care, or cognitive — roughly 3.5 million people, not a small edge case.</li><li><strong>Health:</strong> 1 in every 2 children in Guatemala suffers some degree of chronic malnutrition, which can affect long-term cognitive development.</li>',
      'ixdf-meet4-takeaways-h2': 'Key Takeaways for Accessible Design',
      'ixdf-meet4-takeaways-ul': '<li><strong>Design for low literacy first:</strong> pair every critical flow with clear iconography, plain language, and text-to-speech so users who can\'t read fluently can still complete a task.</li><li><strong>Treat multi-language support as core, not a stretch goal</strong> — starting with the most widely spoken Mayan languages instead of defaulting to Spanish-only.</li><li><strong>Follow WCAG color contrast guidelines</strong> and offer both light and dark modes — not just for aesthetics, but for users with light sensitivity.</li><li><strong>Use real, visible form labels outside the input</strong> instead of placeholder-only text, so screen readers and low-literacy users alike can understand what\'s being asked.</li><li><strong>Add proper alt text and aria-labels</strong> to every icon and image — voice-over tools read the code, not the pixels.</li><li><strong>Ship icons and logos as SVGs</strong> instead of compressed JPGs/PNGs, so they stay legible when a user zooms in instead of pixelating.</li><li><strong>Use inclusive, person-first language</strong> when referring to users with different abilities, rather than labeling people by a disability.</li>',
      'ixdf-meet4-examples-h2': 'Examples From the Community',
      'ixdf-meet4-examples-p':  'During the discussion, attendees shared real Guatemalan examples on both ends of the spectrum: self-checkout kiosks at a major supermarket chain that speak instructions aloud as you scan; a utility company\'s bill-payment app praised for being simple and functional; and products like Duolingo cited as accessible by design. On the other side, parking payment machines and gym check-in kiosks came up repeatedly as confusing, inconsistent experiences that force users to relearn the interaction every single time.',
    },
    ...
    es: {
      ...
      'yotaxi-sentry-h2':           'Sentry: Monitoreo de Errores & Seguimiento de Eventos',
      ...
      /* ── IxDF Meet #4 ── */
      'ixdf-meet4-page-title': 'Interaction Design Foundation (IxDF) Guatemala City Meet #4: El Reto de la Accesibilidad en Guatemala',
      'ixdf-meet4-title':      'IxDF Guatemala City Meet #4: Accesibilidad en Guatemala',
      'ixdf-meet4-host':       'Rodrigo Meoño<br><span class="text-grey">Senior UX Developer</span><br><span class="text-grey">Country Manager @ IxDF Guatemala</span>',
      'ixdf-meet4-intro':      'Diseñar para más de 25 culturas: ese es el reto de la accesibilidad en Guatemala. En esta sesión del Meet #4 de IxDF Guatemala City, guié a la comunidad local de UX a través de por qué la accesibilidad merece más atención en Guatemala que en casi cualquier otro mercado. Partiendo del panal de UX clásico —útil, usable, encontrable, creíble, deseable, accesible y valioso—, expliqué que la accesibilidad significa que cualquier persona, sin importar sus capacidades, debe poder usar lo que diseñamos, y que la equidad significa ajustar nuestras herramientas para que todos, no solo la mayoría, puedan llegar realmente al mismo resultado. A partir de ahí exploramos el movimiento "The Next Billion Users" de Google y una serie de estadísticas socioeconómicas que hacen que el panorama de diseño en Guatemala sea particularmente desafiante, antes de abrir la sesión a una discusión interactiva y un ejercicio colaborativo en Jamboard sobre cómo los productos locales podrían volverse más accesibles.',
      'ixdf-meet4-about-h2':   'Sobre la Sesión',
      'ixdf-meet4-about-p':    'El objetivo de la charla era mostrar que la accesibilidad no es una casilla que se marca: es una respuesta directa a quiénes son realmente nuestros usuarios. Compartí el proceso de investigación cuantitativa que uso con cada cliente, en Guatemala o en el extranjero, antes de diseñar una sola pantalla: reunir datos demográficos concretos sobre alfabetización, idioma, ingresos, acceso bancario y tasas de discapacidad antes de asumir cómo alguien va a usar un producto. Después abrimos la sesión al grupo —diseñadores UX, desarrolladores y líderes de equipo de toda Guatemala— para compartir ejemplos reales de apps y tecnología cotidiana que sí lograron ser accesibles, y otras que claramente no.',
      'ixdf-meet4-stats-h2':   'Guatemala en Números',
      'ixdf-meet4-stats-p':    'Estas son algunas de las estadísticas que compartí para basar la conversación en datos y no en suposiciones:',
      'ixdf-meet4-stats-ul':   '<li><strong>Población e idioma:</strong> 18 millones de personas, de las cuales aproximadamente el 70% habla español. El país reconoce oficialmente 25 idiomas —español, 22 idiomas de origen maya, xinca y garífuna— hablados por unos 6 millones de personas que no se comunican principalmente en español.</li><li><strong>Alfabetización:</strong> Una tasa de alfabetización adulta estimada del 83%, lo que significa que aproximadamente 1 de cada 5 adultos —unos 3 millones de personas— todavía no sabe leer ni escribir.</li><li><strong>Educación:</strong> Solo el 54.6% de las personas mayores de 25 años completó la primaria, el 33.9% terminó los básicos y apenas el 5.1% tiene un título universitario.</li><li><strong>Conectividad:</strong> Cerca de 20.4 millones de conexiones de celular para la población, pero solo entre un 56% y 60% de penetración de internet y aproximadamente 10.4 millones de cuentas activas en redes sociales.</li><li><strong>Economía y banca:</strong> El 56% de la población se encuentra en condición de pobreza (16.2% en pobreza extrema), y solo el 65% de los adultos tiene una cuenta de banco.</li><li><strong>Discapacidad:</strong> El 22.4% de los adultos de 15 años o más reporta alguna dificultad funcional —visual, de movilidad, de autocuidado o cognitiva— es decir, unos 3.5 millones de personas, no un grupo pequeño ni marginal.</li><li><strong>Salud:</strong> 1 de cada 2 niños en Guatemala sufre algún grado de desnutrición crónica, lo cual puede afectar su desarrollo cognitivo a largo plazo.</li>',
      'ixdf-meet4-takeaways-h2': 'Aprendizajes Clave para el Diseño Accesible',
      'ixdf-meet4-takeaways-ul': '<li><strong>Diseñar primero para baja alfabetización:</strong> acompañar cada flujo crítico con iconografía clara, lenguaje sencillo y dictado por voz para que quienes no leen con fluidez puedan completar una tarea de todas formas.</li><li><strong>Tratar el soporte multi-idioma como algo esencial, no como un extra</strong> —empezando por los idiomas mayas más hablados en lugar de usar español por defecto.</li><li><strong>Seguir los estándares de contraste de color de WCAG</strong> y ofrecer modo claro y oscuro —no solo por estética, sino para personas con alta sensibilidad a la luz.</li><li><strong>Usar etiquetas de formulario reales y visibles fuera del campo</strong> en lugar de solo texto de relleno (placeholder), para que tanto los lectores de pantalla como las personas con baja alfabetización entiendan qué se les pide.</li><li><strong>Agregar texto alternativo y aria-labels</strong> a cada ícono e imagen —las herramientas de lectura por voz leen el código, no los píxeles.</li><li><strong>Publicar íconos y logos en formato SVG</strong> en lugar de JPG/PNG comprimidos, para que se mantengan legibles al hacer zoom en vez de pixelarse.</li><li><strong>Usar un lenguaje inclusivo centrado en la persona</strong> al referirse a usuarios con diferentes capacidades, en lugar de etiquetarlos por una discapacidad.</li>',
      'ixdf-meet4-examples-h2': 'Ejemplos de la Comunidad',
      'ixdf-meet4-examples-p':  'Durante la discusión, los asistentes compartieron ejemplos reales de Guatemala en ambos extremos: cajas de auto pago en una de las cadenas de supermercados más grandes que dictan las instrucciones en voz alta mientras escaneas los productos; la app de pago de recibos de una empresa eléctrica, elogiada por ser simple y funcional; y productos como Duolingo, mencionados como accesibles desde su diseño. Del otro lado, las máquinas de pago de parqueo y las cajas de registro de gimnasios salieron repetidamente como ejemplos de experiencias confusas e inconsistentes que obligan al usuario a volver a aprender la interacción cada vez.',
    }
  };
